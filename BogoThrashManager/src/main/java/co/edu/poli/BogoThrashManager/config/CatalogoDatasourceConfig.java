...
public class CatalogoDatasourceConfig{
    ...
    @Bean(name = "catalogoEntityManagerFactory")
    ...
    @Bean(name = "catalogoTransactionManager")
    public PlatformTransactionManager cancionTransactionManager(
            @Qualifier("catalogoEntityManagerFactory") LocalContainerEntityManagerFactoryBean emf) {
